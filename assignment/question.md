...
Hero: Hady the Warrior
Student ID: 16001639
GitHub account: hadyayman288

A **Ash Phoenix** bars the way near **the Red Sea coast**. It only falls to
the exact blow.
...
4. Your warcry — copy the line below exactly, including punctuation:
   ...
   "By the Red Sea coast, the Ash Phoenix flees!"
